 ...
 * MarshalledObject form. When accessed in the same VM as the JNP server, the
 * raw object reference is used to avoid deserialization.
 * 
...
public class MarshalledValuePair implements Serializable {
	 ...
	 * 
	 * @return false if all lookups are unmarshalled using the caller's TCL, true if
