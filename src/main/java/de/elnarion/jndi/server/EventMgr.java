...
public interface EventMgr {
	 ...
	 * @param type       - one of
	 *                   {@link javax.naming.event.NamingEvent#OBJECT_ADDED},
	 *                   {@link javax.naming.event.NamingEvent#OBJECT_CHANGED},
	 *                   {@link javax.naming.event.NamingEvent#OBJECT_REMOVED}
	 *                   events.
	 * @param changeInfo - the provider specific change information. The current
	 *                   impl passes in the name of the operation that generated the
	 *                   event.
	 ...
	 */
	void fireEvent(Name fullName, Binding oldb, Binding newb, int type, String changeInfo, EventListeners listeners,
			Set<Integer> scopes);
}
