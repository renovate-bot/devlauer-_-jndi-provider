/*
  ...
  */
package de.elnarion.jndi.client;
...
/**
 * This is a test client of the NamingServer. It calls the server in various
 * ways to test the functionality.
 *
 * <p>
 * The JNDI configuration is provided in the jndi.properties file.
 *
 * @see de.elnarion.jndi.interfaces.NamingContext
 * 
 * @author oberg
 * @author Scott_Stark@displayscape.com
 */
public class Main implements Runnable {
	de.elnarion.jndi.server.Main remoteServer;
	...
	public static void main(String[] args) throws Exception {
		System.setProperty("java.naming.factory.initial", "de.elnarion.jndi.interfaces.NamingContextFactory");
		System.setProperty("java.naming.factory.url.pkgs", "de.elnarion.jndi.interfaces");
	...
	public void run() {
		try {
			...
			env.setProperty(Context.INITIAL_CONTEXT_FACTORY, "de.elnarion.jndi.interfaces.NamingContextFactory");
			env.setProperty(Context.URL_PKG_PREFIXES, "de.elnarion.jndi.interfaces");
	...
	private void runRemoteServer() throws Exception {
		remoteServer = new de.elnarion.jndi.server.Main();
	 ...
	 */
	private void showTree(String indent, Context ctx, int depth, int maxDepth) throws NamingException {
		if (depth == maxDepth)
			return;
