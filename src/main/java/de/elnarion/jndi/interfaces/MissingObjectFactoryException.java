...
/**
 * Indicates that a client has looked up a {@link Reference} pointing to an
 * {@link ObjectFactory} that is not available on the classpath or cannot
 * otherwise be found.
 * <p>
 * JBNAME-42
 *
...
public class MissingObjectFactoryException extends NamingException {
	 ...
	 * @return the missing object factory exception
	...
	public static MissingObjectFactoryException create(final String missingObjectFactoryClassName, final Name targetName)
		...
		String sb = ERROR_MESSAGE_PREFIX +
				targetName +
				ERROR_MESSAGE_SUFFIX +
				missingObjectFactoryClassName;

		// Create and return a new Exception
		return new MissingObjectFactoryException(sb);
	}
}
